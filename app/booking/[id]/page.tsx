  ...
  const availableDates = useMemo(() => {
    ...
    for (let i = 0; i < 14; i++) {
      ...
      const availabilityKey =
        consultationType === "clinic" ? "clinic" : "online";
      const isAvailable =
        doctor?.availability?.[availabilityKey]?.includes(dayName);
            ...
            <Card className="text-center py-12">
              <CardContent>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Your appointment with Dr. {doctor.name} has been successfully
                  booked.
                </p>
                ...
                <>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Please provide details about your condition to help the
                        doctor prepare
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950/60 p-3 rounded-lg">
                      <p className="text-sm text-blue-800 dark:text-blue-300">
                        ...
                        {consultationType === "video"
                          ? "video call"
                          : "phone call"}{" "}
                        link/number before your appointment.
                      </p>
                    </div>
                  )}
                </CardContent>
