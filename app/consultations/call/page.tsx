...
export default function CallConsultationPage() {
  ...
  const loadDoctors = async () => {
    try {
      ...
      const callConsultationDoctors = doctorsData.filter((doctor) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Get medical advice through secure phone consultations
            </p>
          </div>
            ...
            <>
              <div className="mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  {filteredDoctors.length !== 1 ? "s" : ""} available for phone
                  consultation
                </p>
              </div>
                      ...
                      <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-4 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                            <Badge
                              variant="secondary"
                              className="text-xs w-fit mb-2 sm:mb-0"
                            >
